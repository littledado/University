...
int main(int argc, char **argv) {
  ...
  fin = fopen("C:\\Users\\david\\Desktop\\CodiciSorgenti\\University\\AlgoritmiEProgrammazione\\Laboratori\\Lab09\\Esercizio2\\pg.txt","r");
  ...
  fin = fopen("C:\\Users\\david\\Desktop\\CodiciSorgenti\\University\\AlgoritmiEProgrammazione\\Laboratori\\Lab09\\Esercizio2\\inventario.txt","r");
  ...
  do {
    ...
    case 6: {
      ...
      pgp = pgList_searchByCode(pgList, codiceRicerca);
      if (pgp!=NULL) {
        pg_updateEquip(stdin, pgp, invArray);
      }
    } break;
